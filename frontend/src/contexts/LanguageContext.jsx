...
const dictionary = {
  zh: {
    ...
    configuration: "排表配置",
    solverSettings: "求解器设置",
    solverType: "求解器",
    beamSolver: "束搜索（原版）",
    gurobiSolver: "Gurobi（整数优化）",
    solverTimeLimit: "Gurobi 时间上限（秒）",
    solverMipGap: "Gurobi MIPGap",
    solverRuntime: "求解耗时",
    solverStatus: "求解状态",
    solverBestBound: "最优界",
  ...
  en: {
    ...
    solverType: "Solver",
    beamSolver: "Beam Search (Original)",
    gurobiSolver: "Gurobi (MIP)",
    solverTimeLimit: "Gurobi Time Limit (s)",
    solverMipGap: "Gurobi MIP Gap",
    solverRuntime: "Runtime",
    solverStatus: "Solver Status",
    solverBestBound: "Best Bound",
